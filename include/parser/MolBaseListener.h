...
public:
    ...
    virtual void
    enterRamificacao(MolParser::RamificacaoContext * /*ctx*/) override {
    }
    virtual void
    exitRamificacao(MolParser::RamificacaoContext * /*ctx*/) override {
    }

    virtual void
    enterInsaturacao(MolParser::InsaturacaoContext * /*ctx*/) override {
    }
    virtual void
    exitInsaturacao(MolParser::InsaturacaoContext * /*ctx*/) override {
    }

    virtual void
    enterGrupo_funcional(MolParser::Grupo_funcionalContext * /*ctx*/) override {
    }
    virtual void
    exitGrupo_funcional(MolParser::Grupo_funcionalContext * /*ctx*/) override {
    }
